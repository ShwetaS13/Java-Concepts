/* Program to create a linked list and execute functions like create a node, add link, delete link, display linked list  */
class Node 
{
	// assume the data part contains only integer values
	int number;
    Node next;
